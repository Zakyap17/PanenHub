...
<head>
    ...
    <style>
        ...
        .btn-edit { color: var(--primary-green) !important; border-color: var(--primary-green) !important; }
        .btn-edit:hover { background-color: var(--primary-green) !important; color: white !important; }
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-outline-success btn-sm rounded-pill px-3 btn-edit" 
...
<div class="modal fade" id="editProductModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold text-success"><i class="bi bi-pencil-square me-2"></i> Edit Hasil Panen</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
