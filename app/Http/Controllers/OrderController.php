...
class OrderController extends Controller
{
    public function checkout(Request $request)
    {
        $validator = \Validator::make($request->all(), [
            ...
            'cart' => 'required|json',
            'proof_of_payment' => 'nullable|file|mimes:jpg,jpeg,png,webp|max:10240',
        ]);
        ...
        if ($request->hasFile('proof_of_payment')) {
            ...
            if ($file->isValid()) {
                ...
                return back()->withErrors(['proof_of_payment' => 'Gagal mengunggah file: ' . $file->getErrorMessage()])->withInput();
            }
        }
